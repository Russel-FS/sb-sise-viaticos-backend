...
CREATE TABLE zonas_geograficas (
    ...
    nombre_zona VARCHAR2 (50) NOT NULL, -- Ej: Zona A (Lima), Zona B (Provincia)
...
CREATE TABLE niveles_jerarquicos (
    ...
    nombre_nivel VARCHAR2 (50) NOT NULL, -- Ej: Gerente, Supervisor, Técnico
    descripcion VARCHAR2 (200)
);
...
CREATE TABLE tipos_gasto (
    ...
    nombre_gasto VARCHAR2 (50) NOT NULL, -- Ej: Alimentación, Hospedaje, Movilidad, Lavandería
    requiere_factura NUMBER (1) DEFAULT 1 CHECK (requiere_factura IN (0, 1)),
    cuenta_contable VARCHAR2 (20), -- Ej: 63.1.1
    es_asignable_por_dia NUMBER (1) DEFAULT 1 CHECK (
        es_asignable_por_dia IN (0, 1)
    ) -- Indica si este concepto entra en el cálculo diario automático
);
...
CREATE TABLE tarifario_viaticos (
    ...
    id_tipo_gasto NUMBER NOT NULL, -- Relación con el concepto específico
    monto_limite_diario NUMBER (10, 2) NOT NULL, -- El tope asignado
...
CREATE TABLE detalle_comprobantes (
    ...
    id_tipo_gasto NUMBER NOT NULL, -- Aquí indicas qué concepto fue (Alimentación, etc.)
    ruc_proveedor CHAR(11),
    razon_social_proveedor VARCHAR2 (150),
    serie_numero_comprobante VARCHAR2 (50),
